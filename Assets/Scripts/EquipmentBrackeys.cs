...
public class EquipmentBrackeys : MonoBehaviour
{
    ...
    public static EquipmentBrackeys instance;
    ...
    void Start()
    {
        inventory = Inventory.inventoryInstance;     // Get a reference to our inventory
    ...
    {
        foreach (MeshBlendShape blendshape in item.coveredRegions)
        {
